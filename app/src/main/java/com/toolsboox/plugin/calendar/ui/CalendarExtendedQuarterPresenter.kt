...
/**
 * Calendar extended quarter presenter.
 *
 * @author <a href="mailto:gabor.auth@toolsboox.com">Gábor AUTH</a>
 */
class CalendarExtendedQuarterPresenter @Inject constructor() : FragmentPresenter() {
    /**
     * Load the extended quarter if available.
     *
     ...
     */
    fun load(
        fragment: CalendarExtendedQuarterFragment, binding: FragmentCalendarQuarterBinding,
    ...
    private fun createPath(fragment: ScreenFragment, currentDate: LocalDate): File {
        ...
        return File(path, "quarter-e-$year-$quarter.json")
    }
}
