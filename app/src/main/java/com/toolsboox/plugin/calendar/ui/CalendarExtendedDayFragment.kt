...
import com.toolsboox.plugin.calendar.ot.CalendarExtendedDayCreator
...
/**
 * Calendar extended day view fragment.
 *
 * @author <a href="mailto:gabor.auth@toolsboox.com">Gábor AUTH</a>
 */
@AndroidEntryPoint
class CalendarExtendedDayFragment @Inject constructor() : SurfaceFragment() {

    /**
     * The presenter of the fragment.
     */
    @Inject
    lateinit var presenter: CalendarExtendedDayPresenter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.surfaceView.setOnTouchListener { view, motionEvent ->
            ...
            CalendarExtendedDayCreator.onTouchEvent(
                view, motionEvent, gestureResult, this@CalendarExtendedDayFragment, calendarDay
            )
        }
    ...
    override fun onResume() {
        ...
        timer = GlobalScope.launch(Dispatchers.Main) {
            presenter.load(this@CalendarExtendedDayFragment, binding, currentDate, getSurfaceSize())
        }
    }
    ...
    fun renderPage(calendarDay: CalendarDay) {
        ...
        CalendarExtendedDayCreator.drawPage(this.requireContext(), templateCanvas, calendarDay)
        binding.templateImage.postInvalidate()
