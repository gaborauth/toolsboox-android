...
import com.toolsboox.plugin.calendar.ui.CalendarExtendedWeekFragment
 ...
 */
class CalendarExtendedWeekCreator : Creator {
    ...
    companion object {
        ...
        fun onTouchEvent(
            ...
            fragment: CalendarExtendedWeekFragment, calendarWeek: CalendarWeek
        ): Boolean {
