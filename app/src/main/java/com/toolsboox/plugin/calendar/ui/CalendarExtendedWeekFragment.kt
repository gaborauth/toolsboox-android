...
import com.toolsboox.plugin.calendar.ot.CalendarExtendedWeekCreator
...
/**
 * Calendar extended week view fragment.
 *
 * @author <a href="mailto:gabor.auth@toolsboox.com">Gábor AUTH</a>
 */
@AndroidEntryPoint
class CalendarExtendedWeekFragment @Inject constructor() : SurfaceFragment() {

    /**
     * The presenter of the fragment.
     */
    @Inject
    lateinit var presenter: CalendarExtendedWeekPresenter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.surfaceView.setOnTouchListener { view, motionEvent ->
            ...
            CalendarExtendedWeekCreator.onTouchEvent(
                view, motionEvent, gestureResult, this@CalendarExtendedWeekFragment, calendarWeek
            )
        }
    ...
    override fun onResume() {
        ...
        timer = GlobalScope.launch(Dispatchers.Main) {
            presenter.load(
                this@CalendarExtendedWeekFragment,
                binding,
                currentDate,
                getSurfaceSize(),
                Locale.getDefault()
    ...
    fun renderPage(calendarWeek: CalendarWeek) {
        ...
        CalendarExtendedWeekCreator.drawPage(this.requireContext(), templateCanvas, calendarWeek)
        binding.templateImage.postInvalidate()
