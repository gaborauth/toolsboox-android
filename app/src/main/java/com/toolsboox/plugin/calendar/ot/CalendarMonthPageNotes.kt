...
class CalendarMonthPageNotes : Creator {
    ...
    companion object {
        ...
        fun onTouchEvent(
            ...
            fragment: CalendarMonthFragment, calendarMonth: CalendarMonth, notePage: String
        ): Boolean {
            ...
            when (gestureResult) {
                OnGestureListener.UTD -> {
                    if (page == 0) {
                        ...
                        CalendarNavigator.toMonthNote(fragment, localDate, "${page - 1}")
                    }
                    return true
                }
         ...
         * @param notePage current notePage
         */
        fun drawPage(context: Context, canvas: Canvas, calendarMonth: CalendarMonth, template: Int, notePage: String) {
            val page = notePage.toIntOrNull() ?: 0
